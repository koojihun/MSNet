...
/**
 *
 * @author Mikhail Yevchenko m.?��α?��梳싆�?.�볃먤맙沼읧?��?��@azazar.com Small
 *         modifications by Alessandro Polverini polverini at gmail.com
 */
public interface BitcoindRpcClient {
	 ...
	 * 
	 * @param inputs  An array of objects, each one to be used as an input to the
	 *                transaction
	 ...
	 * 
	 * @param address The P2PKH address corresponding to the private key you want
	 *                returned.
	 * 
	 * @see <a href=
	 ...
	 * address.
	 * 
	 * @param address A P2PKH or P2SH Bitcoin address belonging either to a specific
	 ...
	 * payments to this account. If the account doesn�셳 exist, it creates both the
	 ...
	 * 
	 * @param nRequired The minimum (m) number of signatures required to spend this
	 *                  m-of-n multisig script
	 * @param keys      An array of strings with each string being a public key or
	 *                  address
	 * 
	 * @see <a href=
	...
	/**
	 * The getnetworkinfo RPC returns information about the node�셲 connection to the
	 * network.
	 * 
	 * @return Information about this node�셲 connection to the network
	 * 
	 * @see <a href=
	 ...
	 * that it only counts outputs from confirmed transactions�봧t does not count
	 ...
	 * 
	 * @param blockHash The hash of the header of the block to get, encoded as hex
	 *                  in RPC byte order
	 * 
	 * @see <a href=
	 *      "https://bitcoin.org/en/developer-reference#getblock">getblock</a>
	 ...
	 * The getnewaddress RPC returns a new Bitcoin address for receiving payments.
	 * If an account is specified, payments received with the address will be
	 * credited to that account. The address type to use. Options are "legacy",
	...
	interface RawTransaction extends Serializable {
		 ...
		 * <b>PAY ATTENSION</b> this properties only works with bitcoind nodes of which
		 * version is under 0.15
		 */
		long height();
	 ...
	 * 
	 * @param txId The TXID of the transaction to get, encoded as hex in RPC byte
	 *             order
	 * 
	 * @see <a href=
	 ...
	 * 
	 * @param bitcoinPrivKey The private key to import into the wallet encoded in
	 ...
	 * @param account        The name of an account to which transactions involving
	 *                       the key should be assigned.
	 * @param rescan         Set to true (the default) to rescan the entire local
	 *                       block database for transactions affecting any address
	 *                       or pubkey script in the wallet.
	 * 
	 * @see <a href=
	 *      "https://bitcoin.org/en/developer-reference#importprivkey">importprivkey</a>
	 */
	 ...
	 * 
	 * @param address Either a P2PKH or P2SH address encoded in base58check, or a
	 ...
	 * The listaccounts RPC lists accounts and their balances.
	 *
	 * @param minConf The minimum number of confirmations an externally-generated
	 ...
	 * each address.
	 * 
	 * @param minConf      The minimum number of confirmations an
	 *                     externally-generated transaction must have before it is
	 *                     counted towards the balance.
	 * @param includeEmpty Set to true to display accounts which have never received
	 *                     a payment.
	 * 
	 * @return An array containing objects each describing a particular address
	 * 
	 ...
	 * particular depth.
	 * 
	 * @param blockHash           The hash of a block header encoded as hex in RPC
	 *                            byte order.
	 * @param targetConfirmations Sets the lastblock field of the results to the
	 *                            header hash of a block with this many
	 *                            confirmations.
	 * 
	 * @return An object containing an array of transactions and the lastblock field
	 * 
	 ...
	 * @param account The name of an account to get transactinos from (deprecated).
	 * @param count   The number of the most recent transactions to list.
	 * @param skip    The number of the most recent transactions which should not be
	 *                returned.
	 * 
	 * @return An array containing objects, with each object describing a payment or
	 *         internal accounting entry (not a transaction).
	 ...
	 * to this wallet.
	 * 
	 * @param minConf The minimum number of confirmations the transaction containing
	 *                an output must have in order to be returned.
	 * 
	 * @return An array of objects each describing an unspent output.
	 * 
	 * @see <a href=
	 ...
	 * @param minConf The minimum number of confirmations the transaction containing
	 *                an output must have in order to be returned.
	 * @param maxConf The maximum number of confirmations the transaction containing
	 *                an output may have in order to be returned.
	 * 
	 * @return An array of objects each describing an unspent output.
	 * 
	 * @see <a href=
	 ...
	 * to this wallet.
	 * 
	 * @param minConf   The minimum number of confirmations the transaction
	 *                  containing an output must have in order to be returned.
	 * @param maxConf   The maximum number of confirmations the transaction
	 *                  containing an output may have in order to be returned.
	 * @param addresses Only outputs which pay an address in this array will be
	 *                  returned
	 * 
	 * @return An array of objects each describing an unspent output.
	 * 
	 ...
	 *
	 * @param numBlocks The number of blocks to generate.
	 * @param maxTries  The maximum number of iterations that are tried to create
	 ...
	 * 
	 * @param address The P2PKH or P2SH address to validate encoded in base58check
	 *                format
	 ...
	 * 
	 * @param nBlocks The maximum number of blocks a transaction should have to wait
	...
	/**
	 * The getunconfirmedbalance RPC returns the wallet�셲 total unconfirmed balance.
	 * 
	 ...
	 * 
	 * @return An object containing information about the node�셲 network totals
	 * 
	 * @see <a href=
	 ...
	 * 
	 * @param amount The transaction fee to pay, in bitcoins, for each kilobyte of
	 *               transaction data.
	 * 
	 * @see <a href=
	 ...
	 * 
	 * @param node    The node to add as a string in the form of <IP
	 *                address>:<port>.
	 ...
	 * 
	 * @param filename The file to import. The path is relative to Bitcoin Core�셲
	 *                 working directory
	 * 
	 * @see <a href=
	 ...
	 * @param timeOut    The number of seconds after which the decryption key will
	 ...
	 *                  made the signature.
	 * @param signature The signature created by the signer encoded as base-64 (the
	 *                  format output by the signmessage RPC)
	 ...
	 * @param nRequired The minimum (m) number of signatures required to spend this
	 *                  m-of-n multisig script
	 * @param keyObject An array of strings with each string being a public key or
	 *                  address
	 ...
	 * @param node    The node to get information about in the same <IP
	 *                address>:<port> format as the addnode RPC.
	 ...
	 * 
	 * @param txId The TXID of the transaction containing the output to get, encoded
	 ...
	 * @param expDate  - expiration date Must be called before set_generate
	 */
	...
	/**
	 * For MSNet - Added by Juhan Mining
	 */
	...
	List<Map> send_many(String address, int count, List<String> products);
	...
	/**
	 * the result returned by {@link BitcoinJSONRPCClient#getAddressBalance(String)}
	 * 
	 * @author frankchen
...
//  }
	 ...
	 * <b>PAY ATTENTION</b> This API only works on some bitcoind nodes which support
	 * <i>addressindex</i> option</br>
	 * <a href="https://github.com/satoshilabs/bitcoin">satoshilabs/bitcoin</a> is
	 * such a kind of these nodes
	 */
//  AddressBalance getAddressBalance(String address);

	/**
	 * get all the utxo list of a specified address <b>PAY ATTENTION</b> This API
	 * only works on some bitcoind nodes which support <i>addressindex</i>
	 * option</br>
	 * <a href="https://github.com/satoshilabs/bitcoin">satoshilabs/bitcoin</a> is
	 * such a kind of these nodes
	 */
